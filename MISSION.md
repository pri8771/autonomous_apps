...
- Official start: **August 24, 2026** (`2026-08-24T15:24:36Z`)
...
After each new verified settled revenue event, one bundled reinvestment cycle may spend no more than **50% of the then-current available cash balance**. At least 50% must remain untouched. Do not renew or evade the cap by splitting purchases, repeatedly spending half of the remainder, using debt, counting pending revenue, or manufacturing transaction events.
