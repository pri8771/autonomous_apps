...
| Analytics | Traffic and funnel measurement | CommerceLint | No third-party analytics configured by design; Primandir HubSpot is excluded and production uses a no-network shim |
